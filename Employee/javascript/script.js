...
function contact_tech(){
  var elements = document.getElementsByClassName('black');
    ...
    setCookie("decice", secondLastData );
    setCookie("device_sub", lastData);      


  myMessage("Nearby technician")
  sendTextMessage("You have requested to assign a technician for your "+lastData +" "+ secondLastData +".");  
  sendTextMessage("Just wait a min...");
  
  setTimeout(function(){ sendTextMessage("We have assigned a neaby technicion for you.");},1000);
  setTimeout(function(){ sendOptMessage("<button class='button-15'>VSYI26YSOM52</button><button class='button-16'><ion-icon style='font-size:20px;margin-top:4px' name='copy-outline'></ion-icon></button>") ;},2000);
  setTimeout(function(){ sendTextMessage("You can start the conversation by searching technician with the above provided searchID, Just copy the searchId and go to the chat screen and in the search bar paste the search id. ");},4000);
  setTimeout(function(){ sendTextMessage("Its just optional our technician will contact you soon, You can just look for his message in the chat screen");},6000);
