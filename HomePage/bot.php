...
<head>
    ...
    <script src="javascript/tv_problems.js"></script>
...
<div class="wrapper">
    <section class="chat-area">
        <header style="background-color:#111828 ;">
  ...
  text-align: center;
    ...
    @keyframes slideUp {
      ...
      to {
        ...
        <div class="sendBar" id="myElement" style="background-color: #111828; width:95%;margin:0 10px 0 10px ; border-radius: 20px; " >
