function tvproblems() {
  ...
  function getSolution(tvType, problem) {
    ...
    var solutions = {
        tvid1: {
          "No display": "If your LED TV is not displaying anything, first check the power cable and ensure it is properly connected to both the TV and the power outlet. Make sure the outlet is working by plugging in another device. If the power connection is fine, verify that the TV is receiving power by checking if the indicator light is on. If there is still no display, it could indicate a hardware issue, and you may need to contact a professional technician for further diagnosis and repair.",
