...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST["unique_id"])) {
      ...
      if ($conn->query($sql1) === TRUE) {
        ...
        $sql2 = "INSERT INTO service_emp (cust_id, emp_id, device,pincode,service_status) VALUES ('$user_id','$centerId','$device','$pincode','Service Approved')";
        if ($conn->query($sql2) === TRUE) {
          
        $sql3 ="UPDATE emp_tech SET s_count = s_count + 1 WHERE unique_id = $centerId";
